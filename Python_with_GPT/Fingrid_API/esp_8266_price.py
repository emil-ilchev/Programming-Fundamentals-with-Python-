    ...
    try:
        ...
        if element:
            ...
            if current_price < 5:
                ...
                requests.get(f"{ESP_IP}/relay/on", timeout=5)
            else:
                print("Цената е над 5 цента. Изключване на релето...")
                requests.get(f"{ESP_IP}/relay/off", timeout=5)
        ...
        print("Изчакване 1 минута преди нов опит...")
        time.sleep(60)  # Изчакване 1 минута преди нов опит
